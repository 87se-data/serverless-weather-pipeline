...
// Google Weather / Maps らしい、クリーンで洗練されたMaterial 3パレット
// ライトモード: 白・オフホワイト・淡いブルーグレーを基調に、アクセントを抑える
...
val md_theme_light_secondaryContainer = Color(0xFFE8F0FF)
...
val md_theme_light_background = Color(0xFFF8FAFD)
...
// ダークモード: 深すぎないグレーと、落ち着いたトーンのアクセント
